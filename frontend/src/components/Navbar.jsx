  ...
  const desktopNav = (
    <>
      ...
      <NavDropdown label="التشغيل" isOpen={ddOpen === 'ops'} onToggle={() => setDdOpen(ddOpen === 'ops' ? null : 'ops')} onClose={closeDd}>
        <Link to="/admin/drivers" className={`nav-dd-link ${isActive('/admin/drivers')}`} onClick={closeDd}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
          السائقين
        </Link>
        <Link to="/admin/attendance" className={`nav-dd-link ${isActive('/admin/attendance')}`} onClick={closeDd}>
      ...
      <NavDropdown label="الإدارة" isOpen={ddOpen === 'mgmt'} onToggle={() => setDdOpen(ddOpen === 'mgmt' ? null : 'mgmt')} onClose={closeDd}>
        <Link to="/admin/penalties" className={`nav-dd-link ${isActive('/admin/penalties')}`} onClick={closeDd}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
          الغرامات
        </Link>
        <Link to="/admin/absences" className={`nav-dd-link ${isActive('/admin/absences')}`} onClick={closeDd}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
          الغيابات
        </Link>
        <Link to="/admin/absence-requests" className={`nav-dd-link ${isActive('/admin/absence-requests')}`} onClick={closeDd}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
          طلبات الغياب
        </Link>
        {isAdmin && (
          <Link to="/admin/justifications" className={`nav-dd-link ${isActive('/admin/justifications')}`} onClick={closeDd}>
      ...
      {isAdmin && (
        <NavDropdown label="النظام" isOpen={ddOpen === 'sys'} onToggle={() => setDdOpen(ddOpen === 'sys' ? null : 'sys')} onClose={closeDd}>
          <Link to="/admin/settings" className={`nav-dd-link ${isActive('/admin/settings')}`} onClick={closeDd}>
          ...
          <Link to="/admin/ops" className={`nav-dd-link ${isActive('/admin/ops')}`} onClick={closeDd}>
          ...
          <Link to="/admin/stations" className={`nav-dd-link ${isActive('/admin/stations')}`} onClick={closeDd}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
            المحطات
          </Link>
          <Link to="/admin/pending-drivers" className={`nav-dd-link ${isActive('/admin/pending-drivers')}`} onClick={closeDd}>
